...
Download the package for your distribution: [`sentil-autosar-adaptive_0.3.0-1_amd64.deb`](https://github.com/sedislab/SENTIL/releases/download/v0.3.0/sentil-autosar-adaptive_0.3.0-1_amd64.deb) for apt, [`sentil-autosar-adaptive-0.3.0-1.x86_64.rpm`](https://github.com/sedislab/SENTIL/releases/download/v0.3.0/sentil-autosar-adaptive-0.3.0-1.x86_64.rpm) for dnf. Both are Linux x86_64 only, and both were built against vsomeip 3.7.3.
