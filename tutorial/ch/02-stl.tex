...
\caption{The robustness of \code{G (speed > 5)} is $-1$: the signal dips to $4$ at $t=3$, one unit under the bound and thus, it fails by one unit.}
\end{figure}
