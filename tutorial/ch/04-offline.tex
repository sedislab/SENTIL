...
\begin{notebox}
You do not have to write formulas as strings. The builder from Chapter~\ref{ch:stl} produces the identical tree, which is what you use when a spec is assembled in a loop or parameterized.
\end{notebox}